    ...
    <div style={{minHeight:"100vh",fontFamily:F}}>
      ...
      <div className="subpage-content" style={{background:"#f5f4f0",padding:"60px 32px 100px"}}>
        <div style={{maxWidth:1100,margin:"0 auto"}}>
          ...
          {/* ─── Sources ─── */}
          <div className="card-section" style={{background:DARK,borderRadius:10,padding:"32px 28px"}}>
    ...
    <div style={{minHeight:"100vh",fontFamily:F}}>
      ...
      <div className="subpage-content" style={{background:"#f5f4f0",padding:"60px 32px 100px"}}>
        <div style={{maxWidth:800,margin:"0 auto"}}>
          ...
          {/* Date Range */}
          <div className="card-section" style={{background:"#fff",borderRadius:0,clipPath:"polygon(15px 0, 100% 0, 100% calc(100% - 15px), calc(100% - 15px) 100%, 0 100%, 0 15px)",border:"2px solid rgba(96,165,250,0.3)",boxShadow:"0 1px 3px rgba(0,0,0,0.04),0 8px 30px rgba(0,0,0,0.06)",padding:"36px 32px",marginBottom:24}}>
          ...
          {/* Need help */}
          <div className="card-section" style={{background:DARK,borderRadius:10,padding:"36px 32px",textAlign:"center"}}>
  ...
  return (
    <div style={{minHeight:"100vh",fontFamily:F}}>
      ...
      <div style={{background:"#f0efeb",padding:"60px 32px",textAlign:"center"}}>
        ...
        <button onClick={()=>onNavigate("home")} style={{padding:"14px 32px",borderRadius:12,border:"none",background:ACC,color:"#fff",fontFamily:F,fontSize:16,fontWeight:600,cursor:"pointer",boxShadow:"0 4px 24px rgba(255,107,90,0.25)"}}>{c("cta.button_text")}</button>
      </div>
    ...
    <div style={{minHeight:"100vh",fontFamily:F}}>
      ...
      <div className="subpage-content" style={{background:"#f5f4f0",padding:"80px 32px 100px"}}>
        <div className="contact-2col" style={{maxWidth:1100,margin:"0 auto",display:"grid",gridTemplateColumns:"1fr 1.2fr",gap:60,alignItems:"start"}}>
          ...
          {/* Right — form */}
          <div className="card-section" style={{background:"#fff",borderRadius:10,boxShadow:"0 1px 3px rgba(0,0,0,0.06),0 8px 30px rgba(0,0,0,0.07)",padding:"32px 32px 28px"}}>
            {submitted ? (
              <div style={{textAlign:"center",padding:"40px 0"}}>
                <div style={{width:64,height:64,borderRadius:10,background:"linear-gradient(135deg,#60a5fa,#3b82f6)",display:"flex",alignItems:"center",justifyContent:"center",margin:"0 auto 20px"}}><IcCheck size={32} color="#fff" strokeWidth={3}/></div>
